      ...
      >
        ...
        <div className="mb-6 text-center">
          ...
          <p className="mt-2 text-xs text-gray-400">
            Create your account and enter the multiverse
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-xs text-gray-300">Username</label>
            <input
              type="text"
              name="username"
        ...
        <p className="mt-4 text-center text-xs text-gray-400">
          ...
          <button onClick={onSwitchToLogin} className="text-violet-400 hover:text-violet-300">
            Login
          </button>
        </p>
      </div>
